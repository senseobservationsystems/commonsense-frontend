...
public class BooleanValueConverter extends SensorValueConverter {
    ...
    public static BooleanValueModel entityToModel(BooleanValue bv) throws JSONException {
        return new BooleanValueModel(bv.getTimestamp(), bv.getValue());
    }

    public static BooleanValue jsonToEntity(int deviceId, int sensorType, JSONObject jsonSensorValue)
            throws JSONException {
        return new BooleanValue(deviceId, sensorType,
    ...
    public static BooleanValue jsonToEntity(JSONObject jsonSensorValue) throws JSONException {
        return new BooleanValue(jsonSensorValue.getInt("device_id"),
    ...
    public static BooleanValueModel[] jsonsToModels(JSONArray jsonBooleanValues, int parentId,
