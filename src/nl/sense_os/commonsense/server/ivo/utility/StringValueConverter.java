...
public class StringValueConverter extends SensorValueConverter {
    ...
    public static StringValueModel entityToModel(StringValue sv) throws JSONException {
        return new StringValueModel(sv.getTimestamp(), sv.getValue());
    }

    public static StringValue jsonToEntity(int deviceId, int sensorType, JSONObject jsonSensorValue)
            throws JSONException {
        return new StringValue(deviceId, sensorType,
    ...
    public static StringValue jsonToEntity(JSONObject jsonSensorValue) throws JSONException {
        return new StringValue(jsonSensorValue.getInt("device_id"),
    ...
    public static StringValueModel[] jsonsToModels(JSONArray jsonStringValues, int parentId,
