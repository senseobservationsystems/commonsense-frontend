...
public class FloatValueConverter extends SensorValueConverter {
    ...
    public static FloatValueModel entityToModel(FloatValue fv) throws JSONException {
        return new FloatValueModel(fv.getTimestamp(), fv.getValue());
    }

    public static FloatValue jsonToEntity(int deviceId, int sensorType, JSONObject jsonSensorValue)
            throws JSONException {
        return new FloatValue(deviceId, sensorType,
    ...
    public static FloatValue jsonToEntity(JSONObject jsonSensorValue) throws JSONException {
        return new FloatValue(jsonSensorValue.getInt("device_id"),
    ...
    public static FloatValueModel[] jsonsToModels(JSONArray jsonFloatValues, int parentId,
