...
public class StringTriggerForm extends WizardFormPanel {
	...
	minButtonGrid.getCellFormatter().setHorizontalAlignment(0, 0,
     ...
     * "Alert if value is equal", and adds it to the layout
     */
    private void createPlusCombo1() {

	LabelField alertEqualLabel = new LabelField(
		"Alert if value is equal to: ");
	...
	LabelField alertUnequalLabel = new LabelField(
		"Alert if value is not equal to: ");
	...
	listener = new SelectionChangedListener<SimpleComboValue<String>>() {
	    ...
	    public void selectionChanged(
		    SelectionChangedEvent<SimpleComboValue<String>> event) {
		boolean ok = false;
