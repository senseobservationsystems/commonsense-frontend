...
public class PosTriggerForm extends FormPanel{
		...
		private void initMapWidget() {
		    ...
		    map.addMapClickHandler (new MapClickHandler() {
		    	...
		    	public void onClick(MapClickEvent event) {	        		
		            ...
		            //LOG.fine ("Latitude is " + point.getLatitude() + " longitude is " + point.getLongitude());                
				...
				public void onClick(MarkerClickEvent event) {
		            ...
		            for (int i = 0; i < circleList.size(); i++ ) {
		            	if (i == sender.getIndex()) {
		          		 // LOG.fine ("CircleList length is " + circleList.size() + " Removing overlay " + sender.getIndex());
	    ...
	    /**
	     * This method is called when the window has already been shown. Without this, the map
	     * will not be displayed properly (computer will think the size is 0);
	     */
