...
public class AccordionForm extends ContentPanel {
	...
	public void createFormFields(IndexFormPanel fp1) {
	    ...
	    ComboBox combo1 = createComboBox();
	    ...
	    TextField address = new TextField<String>();
	...
	public void setDescription(String message) {
    	//TextField description = descriptionList.get(descriptionList.size() -1);
	...
	public void passParentWindowSize(int width, int height) {
        ...
        for (int i = 0; i < formList.size(); i++ ) {
        	...
        	ComboBox combo = fp.getCombo();
        	combo.setWidth(parent_width - SIZE);
        	TextField address = fp.getTextField();
