...
public class NumTriggerForm extends FormPanel {
    ...
    private ArrayList<TextField<String>> fieldList;
    ...
    private TextField<String> box11;
    private TextField<String> box21;
    private TextField<String> box31;
    private TextField<String> box41;
    private TextField<String> box51;
    private TextField<String> box61;
    ...
    private void createTextFields() {
        box11 = new TextField<String>();
        box21 = new TextField<String>();
        box31 = new TextField<String>();
        box41 = new TextField<String>();
        box51 = new TextField<String>();
        box61 = new TextField<String>();

        fieldList = new ArrayList<TextField<String>>();
        fieldList.add(box11);
        fieldList.add(box21);
        fieldList.add(box31);
        fieldList.add(box41);
        ...
        for (int i = 0; i < fieldList.size(); i++) {
            TextField<String> field = fieldList.get(i);
            formatTextField(field);
        }
    }

    private void createControlBox() {
        controlBox = new TextField<String>();
     ...
     * @param box
     */
    private void formatTextField(TextField<String> field) {
        field.setWidth("42px");
    ...
    private void setEnabled(TextField<String>... fields) {
        ...
        ArrayList<TextField<String>> specialFields = new ArrayList<TextField<String>>();
    ...
    public void passData(JsArray<Timeseries> data) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (current_vstart < vstart)
                vstart = current_vstart;
            double current_vend = ts.findMax();
            if (current_vend > vend)
                vend = current_vend;
            orig_vstart = vstart;
            orig_vend = vend;
