...
public class ExtGroup extends ExtUser {
    ...
    public ExtGroup(Map<String, Object> properties) {
        super(properties);
    }

    public ExtGroup(TreeModel parent) {
        super(parent);
    }
    ...
    public ExtGroup setEmail(String email) {
        set(EMAIL, email);
        return this;
    }
    ...
    public ExtGroup setName(String name) {
        set(NAME, name);
        return this;
    }
