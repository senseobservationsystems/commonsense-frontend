 ...
 */
public class EnvironmentsPlace extends Place {

	/**
	 * PlaceTokenizer knows how to serialize the Place's state to a URL token.
	 */
	@Prefix("environments")
	public static class Tokenizer implements PlaceTokenizer<EnvironmentsPlace> {

		@Override
		public EnvironmentsPlace getPlace(String token) {
			return new EnvironmentsPlace(token);
		}

		@Override
		public String getToken(EnvironmentsPlace place) {
	...
	public EnvironmentsPlace() {
		this("");
	}

	public EnvironmentsPlace(String token) {
		this.token = token;
	}
