 ...
 */
public class StatesPlace extends Place {

	/**
	 * PlaceTokenizer knows how to serialize the Place's state to a URL token.
	 */
	@Prefix("states")
	public static class Tokenizer implements PlaceTokenizer<StatesPlace> {

		@Override
		public StatesPlace getPlace(String token) {
			return new StatesPlace(token);
		}

		@Override
		public String getToken(StatesPlace place) {
	...
	public StatesPlace(String token) {
		this.token = token;
	}
