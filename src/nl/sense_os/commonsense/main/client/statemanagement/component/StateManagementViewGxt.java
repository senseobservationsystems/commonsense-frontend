...
public class StateManagementViewGxt extends Composite implements StateManagementView {

	private static final Logger LOG = Logger.getLogger(StateManagementViewGxt.class.getName());
