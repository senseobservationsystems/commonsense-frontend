 ...
 */
@WithTokenizers({ AllInOnePlace.Tokenizer.class, EnvironmentsPlace.Tokenizer.class,
		GroupsPlace.Tokenizer.class, LogoutPlace.Tokenizer.class,
		SensorsPlace.Tokenizer.class, StatesPlace.Tokenizer.class })
