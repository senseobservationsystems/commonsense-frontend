 ...
 */
public class SensorManagementActivity extends AbstractActivity implements
		SensorManagementView.Presenter {
	private static final Logger LOG = Logger.getLogger(SensorManagementActivity.class.getName());
	/**
	...
	private SensorManagementView view;
	private static final int PER_PAGE = 1000;
	private boolean isLoadingUsers;
	private boolean isLoadingServices;

	public SensorManagementActivity(SensorManagementPlace place, MainClientFactory clientFactory) {
	...
	@Override
	public void loadData(AsyncCallback<ListLoadResult<ExtSensor>> callback, boolean renewCache) {
	...
	public void start(AcceptsOneWidget containerWidget, EventBus eventBus) {
		...
		view = clientFactory.getSensorManagementView();
