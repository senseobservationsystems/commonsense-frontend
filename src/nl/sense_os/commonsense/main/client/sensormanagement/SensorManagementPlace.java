 ...
 */
public class SensorManagementPlace extends Place {
	...
	public static class Tokenizer implements PlaceTokenizer<SensorManagementPlace> {
		...
		@Override
		public SensorManagementPlace getPlace(String token) {
			return new SensorManagementPlace(token);
		}

		@Override
		public String getToken(SensorManagementPlace place) {
	...
	public SensorManagementPlace() {
		this("");
	}

	public SensorManagementPlace(String token) {
		this.token = token;
	}
