...
import nl.sense_os.commonsense.main.client.visualization.component.map.DateSlider;
...
public class MapPanel extends VizPanel {
    ...
    public MapPanel(List<GxtSensor> sensors, long start, long end, boolean subsample, String title) {
        super();
